...
ebv_tabelle_3 = [
    ...
    # NEU: Kohlenwasserstoffe getrennt
    ...
    {"ebv_order": 27, "parameter": "PAK15", "einheit": "mg/kg", "typ": "Feststoff", "fussnoten": [9], "grenzwerte": {"BM_0*": 0.2, "BM_F0*": 0.3, "BM_F1": 1.5, "BM_F2": 3.8, "BM_F3": 20}},
...
# NEU: Exaktes Mapping zur Vermeidung von Fehlern
SYNONYM_MAPPING = {
    ...
    "TOC": "TOC",
    "Naphthalin": "Naphthalin und Methylnaphthaline, gesamt",
